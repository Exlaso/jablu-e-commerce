    ...
    <>
      <div>
        <fieldset className={"first:rounded-t-2xl last:rounded-b-2xl"}>
            ...
            return (
              ...
              >
                ...
                <div className={"flex justify-between flex-col "}>
                  <p>
                    {e.address1} , {e.address2} {e.city} - {e.pincode},{" "}
                    {e.regionstate} , {e.region}
                  </p>
          ...
          <button
            className={
              "w-full my-2 py-4 px-4 rounded-lg bg-secondary text-primary disabled:brightness-50 duration-300"
            }
            type={"button"}
            disabled={selectedaddress === ""}
            onClick={() => {
              const address = props.Addresses.addresses.find(
                (e) => e.address_id === selectedaddress,
              );
              if (address) {
          ...
          <p
            className={
              "border-y-2 border-gray-500 my-10 py-2 px-20 text-center"
            }
          >
            OR
          </p>
      ...
      <form onSubmit={handleformsubmit} className={"flex flex-col gap-4"}>
        ...
        <div className={"w-full flex flex-col gap-4"}>
          ...
          <div className={"w-full flex flex-col gap-4"}>
            ...
            <button
              className={
                "w-full py-4 px-4 rounded-lg bg-secondary text-primary"
              }
              type={"submit"}
            >
