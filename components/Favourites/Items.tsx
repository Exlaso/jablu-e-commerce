                            ...
                            >
                                <Link href={"/Products/" + e.product.title.replaceAll(" ", "-")}>
                                    <Image
                                        ...
                                        width={150}
                                        height={150}
                                        className={`aspect-square object-contain   ${isdarkmode ? "bg-black/50" : "bg-white/50"}  rounded-2xl p-2`}
                                    ></Image>
                                </Link>
                                <div className="w-full flex flex-col gap-3">
                                    <div
                                        className="flex max-sm:flex-col  max-sm:text-sm justify-between items-start w-full gap-4">
                                        <Link
