...
} from "@/components/Checkout/AddressDisplay";
...
export const EmailVerificationTemplate = ({
  ...
  <div className="flex flex-col gap-3 p-5">
    ...
    <a href={verifyurl} className="underline text-blue-400">
      {verifyurl}
    </a>
    <p>
...
export const OrderConfirmationEmail = ({
  ...
  return (
    <main style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
      ...
      <p>
        Thank you for your order from Jablu.in. We are pleased to confirm that
        your order #{orderId} has been received and is currently being
        processed.
      </p>
      <hr />
      <ShippingAddressDisplay address={addressdata} />
      <hr />
      <h2 style={{ fontSize: "1.5em", fontWeight: "bold" }}>Order Details:</h2>
      <div>
        <div
          style={{
            display: "grid",
        ...
        >
          {productdata.map((e, i) => {
            ...
            return (
              <div
                style={{ overflow: "hidden", transitionDuration: "300ms" }}
                key={i}
              >
                {" "}
                {i !== 0 && (
                  ...
                  >
                    <div style={{ position: "relative" }}>
                      <img
                        ...
                        src={e.product.images ?? "/static/shuz.png"}
                        alt={e.product.title}
                        width={80}
                        height={80}
                      />
        ...
        >
          ...
          >
            ...
            <span className={"m-1"}>
              Rs.{" "}
              {(total - shippingprice).toLocaleString("en-US", {
                maximumFractionDigits: 2,
              })}
            </span>
          </div>
      ...
      <p>Best regards,</p>
      <p>Jablu.in Support Team</p>
    </main>
  );
};

export const ProductReminderEmail = ({
  products,
  name,
  email,
}: {
  ...
  products: {
    product_id: string;
    product: { description: string; id: string; images: string; title: string };
  }[];
}) => {
  return `<div style="display: grid; flex-direction: column; gap: 3px; padding: 5px;">
...
export const ResetPassword = ({
  ...
  return (
    <main className="flex flex-col gap-3">
      ...
      <p>
        3. After you&apos;ve successfully reset your password, you&apos;ll be
        able to log in to your Jablu.in account with your new credentials. If
        you did not initiate this password reset request, please disregard this
        email. Your account&apos;s security is important to us, and we recommend
        that you change your password if you suspect any unauthorized access.
        Thank you for using Jablu.in. If you have any questions or need further
...
export const AlertRegardingUpdatedPassword = ({
  ...
  return (
    <main className="flex flex-col gap-3">
      ...
      <p>
        If you were the one who initiated this password change, there&apos;s no
        need to take any further action. Your account is now ready for use with
