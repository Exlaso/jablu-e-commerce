...
export const OrderConfirmationEmail = ({
    ...
    name: string;
    orderId: string;
    productdata: { color: string, count: number, size: string, product_id: string, product: { images: string, price: number, title: string } }[];
    total: number,
    ...
    return (
        <main style={{display: "flex", flexDirection: "column", gap: "5px"}}>
            ...
            <div>
                <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2px", margin: "4px"}}>
                    {productdata.map((e, i) => {
                        ...
                        return <div
                            ...
                            <section
                                style={{display: "grid", gridTemplateColumns: "5fr 1fr", paddingTop: "4px", gap: "5px", justifyContent: "space-between", paddingLeft: "2px", paddingRight: "2px"}}>
                                <div style={{display: "grid", gap: "5px", gridTemplateColumns: "90px 1fr"}}>
                                    <div style={{position: "relative"}}>
                                        <img
                                            style={{borderRadius: "5px", borderColor: "rgba(128,128,128,0.5)", borderStyle: "solid", borderWidth: "1px", padding: "1px", objectFit: "contain"}}
                                    ...
                                    <div
                                        style={{display: "inline-block", flexDirection: "column", justifyContent: "space-around"}}>
                ...
                <hr style={{borderColor: "rgba(128,128,128,0.5)"}}/>
                <div
                    style={{display: "grid", flexDirection: "column", gap: "2px", position: "sticky", bottom: "4px", backgroundColor: "transparent", borderColor: "rgba(128,128,128,0.5)", borderStyle: "solid", borderWidth: "0px", padding: "4px", borderRadius: "5px"}}>
                    <div
                        style={{display: "flex",gap:"2px", padding: "4px", justifyContent: "space-between", borderColor: "rgba(128,128,128,0.5)", borderBottomStyle: "solid", borderBottomWidth: "1px"}}>
                    ...
                    <div
                        style={{display: "flex", padding: "4px",gap:"2px", justifyContent: "space-between", borderColor: "rgba(128,128,128,0.5)", borderBottomStyle: "solid", borderBottomWidth: "1px"}}>
                    ...
                    <div
                        style={{display: "flex", padding: "4px",gap:"2px", position: "sticky", justifyContent: "space-between", borderColor: "rgba(128,128,128,0.5)", borderBottomStyle: "solid", borderBottomWidth: "1px", fontSize: "1.2em", fontWeight: "bold"}}>
