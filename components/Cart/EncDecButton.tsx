...
const IncDecButton: FunctionComponent<IncDecButtonProps> = ({
    ...
    const [productCount, setproductCount] = useState<number>(data.count);
    const UpdateHandler = (
    ...
    return (
        <div
            className=" px-4 py-2 text-xl bg-transparent text-highlight border border-[var(--secondary-color)] rounded-full w-28 flex justify-between">
            <button
