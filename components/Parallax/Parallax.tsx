...
const ProccessSection = () => {
  return (
    <div className="grid grid-cols-4 gap-4 my-10 mx-10 max-md:grid-cols-2 max-md:mx-5">
      <div className="flex text-center flex-col gap-3 justify-center  items-center">
        <Image
      ...
      <div className="flex text-center flex-col gap-3 justify-center  items-center">
        <Image
          ...
          height={150}
        ></Image>
        <span className="py-1 px-3  bg-yellow-600/25 rounded-2xl">Step 2</span>
        <h3>Add to bag</h3>
        <p className=" px-[20%]">
      ...
      <div className="flex text-center flex-col gap-3 justify-center  items-center">
        <Image
          ...
          height={150}
        ></Image>
        <span className="py-1 px-3  bg-purple-600/25 rounded-2xl">Step 4</span>
