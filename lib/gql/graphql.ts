...
export type IsEmailExistsQuery = { users: Array<{ user_email: string }> };
...
export type IsPasswordMatchedQueryVariables = Exact<{ [key: string]: never; }>;


export type IsPasswordMatchedQuery = { users: Array<{ user_password: string }> };
...
export const IsPasswordMatchedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"IsPasswordMatched"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"users"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user_password"}}]}}]}}]} as unknown as DocumentNode<IsPasswordMatchedQuery, IsPasswordMatchedQueryVariables>;
