...
export const POST = async (req: NextRequest) => {
   try {
       ...
       */
       const checksum = await PaytmChecksum.generateSignature(JSON.stringify(paytmParams.body), process.env.PAYTM_MERCHANT_KEY as string);
       ...
       if (e instanceof Error) {
           console.log("Error in pretransaction ",e);
           return NextResponse.json({error:true,message: e.name+": "+e.message  })
