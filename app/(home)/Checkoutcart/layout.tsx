...
const CheckoutForm: React.FC<{
  ...
  const Mycartitems: GetMyCartitemsQuery = await gqlClient.request(
    GetMyCartitemsDocument,
    {},
    {
  ...
  if (Mycartitems.cart.length === 0) {
    return (
      <div
        className={
          "flex flex-col justify-center w-full items-center gap-4 p-[15vh]"
        }
      >
        ...
        <div className="w-full">
          <CardSection href={"/Categories"} data={data?.slice(0, 4)}>
            Related Products
          </CardSection>
        </div>
      </div>
