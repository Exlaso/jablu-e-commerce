                ...
                if (error instanceof Error) {
                    ...
                    if (error?.message === "Account Do Not Exists") {
                        ...
                        toast.error(
                            error?.message
                            , {
                                description: error.message === "Verify Your Account to Login" ?
        ...
        <Authdiv>
            ...
            >
                ...
                >
                    {isbtnloading && (
                        <div
                            className="border-4 border-blue-600 border-l-4 border-l-red-600 p-2 rounded-full animate-spin"></div>
                    )}
